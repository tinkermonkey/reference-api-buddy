...
from reference_api_buddy.cli import load_config, create_default_config, main
...
class TestCreateDefaultConfig:
    ...
    def test_create_default_config_cache_settings(self):
        ...
        assert config["cache"]["database_path"] == "test_data/api_buddy_cache.db"
...
class TestCLIConfigurationHandling:
    ...
    def test_cli_with_config_file(self, mock_print, mock_logging, mock_proxy):
        ...
        config_data = {
            "server": {"host": "192.168.1.1", "port": 3000},
            "cache": {"database_path": "custom.db"}
        }
